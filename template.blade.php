...
table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_column_1 .v-col-border { border-top: 12px solid #ffb31f !important;border-left: 10px solid #ffb31f !important;border-right: 10px solid #ffb31f !important;border-bottom: 10px solid #ffb31f !important; } #u_content_text_1 .v-container-padding-padding { padding: 100px 10px 0px !important; } #u_content_text_1 .v-font-size { font-size: 33px !important; } #u_content_text_1 .v-line-height { line-height: 110% !important; } #u_content_text_2 .v-container-padding-padding { padding: 10px 10px 15px !important; } #u_content_image_1 .v-container-padding-padding { padding: 0px !important; } #u_content_image_1 .v-src-width { width: auto !important; } #u_content_image_1 .v-src-max-width { max-width: 100% !important; } #u_content_text_3 .v-container-padding-padding { padding: 30px 10px 10px !important; } #u_content_button_1 .v-size-width { width: 74% !important; } #u_content_social_1 .v-container-padding-padding { padding: 30px 10px 10px !important; } #u_content_text_5 .v-container-padding-padding { padding: 10px 10px 20px !important; } }
    </style>
<!--[if !mso]><!--><link href="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/asset_b2343883.css') }}" rel="stylesheet" type="text/css"/><link href="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/asset_a6f87977.css') }}" rel="stylesheet" type="text/css"/><!--<![endif]-->
</head>
...
<!--[if gte mso 9]>
      <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;min-width: 320px;max-width: 600px;">
        <tr>
          <td background="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/1703019657772-Group_204.png') }}" valign="top" width="100%">
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
        <v:fill type="frame" src="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/1703019657772-Group_204.png') }}" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->
<div class="u-row-container" style="padding: 0px;background-image: url('{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/1703019657772-Group_204.png') }}');background-repeat: no-repeat;background-position: center top;background-color: transparent">
<div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
<div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-image: url('{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/1703019657772-Group_204.png') }}');background-repeat: no-repeat;background-position: center top;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: transparent;"><![endif]-->
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 40px 15px;font-family:'Raleway',sans-serif;">
...
<p style="line-height: 140%;">Join us for our upcoming cardio classes! Stay active, stay healthy!</p>
</div>
</td>
</tr>
</tbody>
...
<img align="center" alt="image" border="0" class="v-src-width v-src-max-width" src="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/1702988794039-3.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 95%;max-width: 551px;" title="image" width="551"/>
</td>
</tr>
</table>
</td>
...
<tbody>
<tr>
<td align="left" class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 40px 10px;font-family:'Raleway',sans-serif;">
<div class="v-line-height v-font-size" style="font-size: 14px; color: #000000; line-height: 140%; text-align: center; word-wrap: break-word;">
<p style="line-height: 140%;">We are excited to remind you about our upcoming cardio classes. Join us for a healthy and energetic workout session!</p>
</div>
</td>
</tr>
</tbody>
...
<div align="center">
<!--[if mso]><table border="0" cellspacing="0" cellpadding="0"><tr><td align="center" bgcolor="#ffb31f" style="padding:10px 20px;" valign="top"><![endif]-->
<a class="v-button v-size-width v-font-size" href="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/asset_2f8c5a96.bin') }}" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #ffb31f; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:30%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-family: inherit; font-size: 14px;" target="_blank">
<span class="v-line-height" style="display:block;padding:10px 20px;line-height:120%;"><strong><span style="line-height: 16.8px;">Join Now</span></strong></span>
</a>
...
<div class="v-line-height v-font-size" style="font-size: 12px; color: #000000; line-height: 140%; text-align: center; word-wrap: break-word;">
<p style="line-height: 140%;">Join our scheduled Cardio Classes for a healthier lifestyle.</p>
</div>
</td>
</tr>
</tbody>
...
<a href="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/asset_0c984410.bin') }}" target="_blank" title="Facebook">
<img alt="Facebook" src="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/facebook.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="Facebook" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<img alt="LinkedIn" src="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/linkedin.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="LinkedIn" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<table border="0" cellpadding="0" cellspacing="0" height="32" style="width: 32px !important;height: 32px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 10px" width="32">
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/asset_9fd8adc6.bin') }}" target="_blank" title="Instagram">
<img alt="Instagram" src="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/instagram.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="Instagram" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<tbody><tr style="vertical-align: top"><td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top" valign="middle">
<a href="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/asset_de62a5c7.bin') }}" target="_blank" title="X">
<img alt="X" src="{{ asset('vendor/mail-templates/cardio-classes-reminder/assets/x.png') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" title="X" width="32"/>
</a>
</td></tr>
</tbody></table>
<!--[if (mso)|(IE)]></td><![endif]-->
...
<p style="font-size: 14px; line-height: 170%;">Dear [Recipient], This is a friendly reminder that your scheduled cardio class is approaching. Please ensure you're prepared and ready to participate.</p>
</div>
</td>
</tr>
</tbody>
